...
const Home = () => {
  return (
    <div name='home' className='flex items-center w-full min-h-screen bg-[#0a192f]'>
        
        {/* Container */}
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            <p className='text-[#E26240]'>Hi, my name is</p>
            ...
            <div>
                <button className='text-white group border-2 border-white-600 px-6 py-3 my-2 flex items-center hover:bg-[#E26240] hover:border-[#E26240]'>View Work 
