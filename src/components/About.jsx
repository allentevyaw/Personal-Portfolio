...
const About = () => {
  return (
    <div name='about' className='w-full min-h-screen flex items-center bg-[#0a192f] text-gray-300'>
        <div className='flex flex-col justify-center items-center w-full h-full'>
            <div className='max-w-[1000px] w-full grid grid-cols-2 gap-8'>
                <div className='sm:text-right pb-8 pl-4'>
                    <p className='text-4xl font-bold inline border-b-4 border-[#E26240]'>About</p>
                </div>
                <div></div>
            </div>
            ...
            <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
                ...
                <div>
                    ...
                    the lives of those around me. I specilize in creating software
